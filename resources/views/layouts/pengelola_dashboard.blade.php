...
<head>
  ...
  <title>Pengelola SIMTA SI</title>
...
<body>
  <div class="main-wrapper">
    @include('template.pengelola_template.sidebar')         
    <div class="page-wrapper">
      @include('template.pengelola_template.header')
      @yield('content')
      @include('template.pengelola_template.footer')
    </div>
  </div>  
