      ...
      <div class="page-content">
        ...
        <nav class="page-breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Mahasiswa Sukses Verifikasi</li>
          </ol>
        </nav>
        ...
        <div class="row">
          <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
              <div class="card-body">
                <h6 class="card-title">List Mahasiswa Sukses Verifikasi</h6>   
                ...
                <div class="table-responsive">
                  <table id="dataTableExample" class="table">
                    ...
                    <tbody>
                      <?php $no=0; foreach ($verifikasi_sukses as $key => $value) { $no++; ?>
                          <tr>
                            <td>{{ $no }}</td>
                              ...
                              <div class="modal-content">
                                ...
                                <div class="modal-body">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="<?php if ($value->status_kkt_file == 0) { ?>Unverified
                                      <?php } elseif ($value->status_kkt_file == 1) { ?>Waiting Verified
                                      <?php }elseif ($value->status_kkt_file == 2) { ?>Verified
                                      <?php }elseif ($value->status_kkt_file == 3) { ?>Rejected
                                      <?php } ?>" readonly>
                                  </div> 
                                  <div class="form-group">
