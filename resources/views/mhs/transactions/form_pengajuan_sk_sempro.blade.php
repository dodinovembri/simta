      ...
      <div class="page-content">
        ...
        <nav class="page-breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Form Pengajuan SK Sempro</li>
          </ol>
        </nav>
          ...
          <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
              <div class="card-body">
                  ...
                  @endif
                  <?php if (empty($cek)) { ?>
                      <form class="cmxform" id="signupForm" method="POST" enctype="multipart/form-data" action="{{route('mhs.transactions.store_mhs_perpanjang_sk_sempro')}}">
                        <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
                        <fieldset>
                          <div class="form-group">
                             <label>SK Sempro</label>                      
                               <input type="file" name="sk_sempro" class="file-upload-default">
                  ...
                  <?php }else{ ?>
                      <div class="alert alert-info" role="alert">Anda sudah mengajukan sk sempro</div>
                  <?php } ?>
              </div>
            </div>
          </div>
