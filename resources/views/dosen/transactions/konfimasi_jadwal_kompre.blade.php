      ...
      <div class="page-content">
        ...
        <nav class="page-breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Konfirmasi Jadwal Kompre</li>
          </ol>
        </nav>
          ...
          <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
              <div class="card-body">
                  ...
                  @endif
                <h6 class="card-title">Konfirmasi Jadwal Kompre</h6>
                            ...
                            <div class="modal-dialog" role="document">
                              <div class="modal-content">
                                ...
                                <div class="modal-body">
                                  ...
                                  <form method="POST" action="{{ route('dosen.transactions.store_konfirmasi_jadwal_kompre_no', $value->nim) }}">  
                                  ...
                                  <a href="{{ route('dosen.transactions.store_konfirmasi_jadwal_kompre_yes', $value->nim) }}"><button type="button" class="btn btn-primary">Bersedia</button></a>
