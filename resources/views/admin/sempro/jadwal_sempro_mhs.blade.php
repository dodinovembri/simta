              ...
              <div class="card-body">
                ...
                <div class="table-responsive">
                    <table class="table">
                      ...
                      <tbody>
                        <?php $no = 0; foreach ($pembimbing as $key => $value) { $no++; ?>
                          <tr>
                            <th>{{$no}}</th>
              ...
              <div class="card-body">
                ...
                <div class="table-responsive">
                    <table class="table">
                      ...
                      <tbody>
                        <?php $no = 0; foreach ($set_penguji as $key => $value) { $no++; ?>
                        <tr>
                          <th>{{$no}}</th>
                          <td><span style="font-family: courier">{{$value->dosen->nip}}</span></td>
          ...
          <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
              <div class="card-body">
                ...
                <form class="cmxform" id="signupForm" method="POST" enctype="multipart/form-data" action="{{route('admin.transactions.store_jadwal_sempro')}}">
