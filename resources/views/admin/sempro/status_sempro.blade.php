              ...
              <div class="card-body">
                ...
                <div class="table-responsive">
                  <table id="dataTableExample" class="table">
                    ...
                    <tbody>
                      <?php $no=0; foreach ($ta_1 as $key => $value) { $no++; ?>
                          <tr>
                            <td>{{ $no }}</td>
                            ...
                            <div class="modal-dialog" role="document">
                              <div class="modal-content">
                                <div class="modal-header">
                                  <h5 class="modal-title" id="exampleModalLabel">Mhs ini Sudah sempro?</h5>
                                ...
                                <div class="modal-body">
                                  ...
                                  <a href="{{ route('dosen.transactions.store_konfirmasi_sudah_sempro', $value->nim) }}"><button type="button" class="btn btn-primary">Sudah sempro</button></a>
