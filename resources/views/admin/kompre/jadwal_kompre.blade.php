      ...
      <div class="page-content">
        ...
        <nav class="page-breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Jadwal Kompre Mahasiswa</li>
          </ol>
        </nav>
        ...
        <div class="row">
          <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
              <div class="card-body">
                <h6 class="card-title">List Jadwal Kompre Mahasiswa</h6>  
                ...
                <div class="table-responsive">
                  <table id="dataTableExample" class="table">
                    ...
                    <tbody>
                      <?php $no=0; foreach ($jadwal_kompre as $key => $value) { $no++; ?>
                          <tr>
                            <td>{{ $no }}</td>
                            <td><a href="{{route('admin.transactions.jadwal_kompre_mhs', $value->nim)}}"><span style="font-family: courier">{{ $value->nim }}</span></a></td>
